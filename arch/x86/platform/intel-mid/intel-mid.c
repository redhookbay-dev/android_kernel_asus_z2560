...
static const struct i2c_board_info hx8528_board_info = {
        I2C_BOARD_INFO("hx8528_me372cl", 0x48),
...
static const struct i2c_board_info sn280x_board_info = {
	I2C_BOARD_INFO("sn280x", 0x6B),
};
#endif
...
{
//printk(KERN_INFO "dev is NULL or platform_data is NULL pentry->type: %d\tpentry->name: %s\n", pentry->type, pentry->name);
			continue;
}
...
#endif
#ifdef CONFIG_SN280X_CHARGER
    i2c_register_board_info(2, &sn280x_board_info, 1);
#endif
#ifdef CONFIG_EC_POWER
...
//add by leo for Goodix touch ++
#ifdef CONFIG_TOUCHSCREEN_GOODIX_GT927
 	printk("set Goodix touch GT927 I2C slave address to 0x5d\n");
	i2c_register_board_info(0, &gt927_board_info, 1);
#endif
//add by leo for Goodix touch --
*/
#ifdef CONFIG_EEPROM_PADSTATION
